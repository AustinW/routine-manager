...
class Pdfdf extends Austinw\Pdfdf\PdfdfFacade{
	 ...
	 * @static 
	 */
	 public static function __construct($fdfUtility, $pdftkDumpParser, $fdfWriter){
		 Austinw\Pdfdf\Pdfdf::__construct($fdfUtility, $pdftkDumpParser, $fdfWriter);
	 }
...
class Zipper extends Chumper\Zipper\Facades\Zipper{
	 ...
	 * @static 
	 */
	 public static function __construct($fs = null){
		 Chumper\Zipper\Zipper::__construct($fs);
	 }
	 ...
	 */
	 public static function extractTo($path, $files = array(), $method = 2){
		 Chumper\Zipper\Zipper::extractTo($path, $files, $method);
	 }
	 ...
	 */
	 public static function __destruct(){
		 Chumper\Zipper\Zipper::__destruct();
	 }
